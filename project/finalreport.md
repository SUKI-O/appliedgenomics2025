...
Assignment Date: November 10, 2025 <br>
Draft report Due: Wednesday Decemeber 10, 2025 <br>
Final Due Date: Tuesday, December 16, 2025 @ 11:59pm 

Each team should submit a PDF of your (draft) final project report (6 to 9 pages) to GradeScope by 11:59pm on Wednesday December 10. Then each team will make an oral presentation of their work on December 11-15. The final report is then due by 11:59pm on Tuesday December 16. No late days can be used as grades must be submitted to the registrar that week.

Using the Bioinformatics style template, the report should have at least:
...
The report must use the Bioinformatics style template. Word and LaTeX templates are available at https://academic.oup.com/bioinformatics/pages/submission_online. You can (and should) expand on your preliminary report into the full report.
